-- Autoformat on Save
vim.cmd [[autocmd InsertLeave (*.elm|*.lua) silent! :lua vim.lsp.buf.formatting()]]
...
-- Telescope Mappings
vim.api.nvim_set_keymap('n', '<Leader>fx', [[<Cmd>lua require('telescope.builtin').find_files()<CR>]], {})
